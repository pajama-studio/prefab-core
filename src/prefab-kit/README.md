...
recursive nesting**, all as plain serializable JSON. Kitchen Lab is the first
host; any project (`/world`, balloon, a new game) can adopt it by satisfying
three structural component fields.
